...
class Pacient(customtkinter.CTk):
    def __init__(self):
        super().__init__()
        ...
        add_buttons = (
            "Date Personale", "Programare", "Vizualizeaza Programare", "Servicii",
            "Orar",)

        datePersonale = createFrame()
        programare = createFrame()
        ...
        totalFrames = (datePersonale, programare, programare_viz, servicii, orar)
