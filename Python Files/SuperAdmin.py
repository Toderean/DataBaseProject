...
class SuperAdmin(customtkinter.CTk):
    def __init__(self):
        super().__init__()
        ...
        add_buttons = (
            "Date Personale", "Vizualizeaza Programare", "Servicii", "Cauta user",
            "Orar", "Concediu")
        ...
        totalFrames = (datePersonale, programare_viz, servicii, search, orar, conc)
        ...
        (GeneralMenu.PersonalData(datePersonale), GeneralMenu.SearchUser(search),
