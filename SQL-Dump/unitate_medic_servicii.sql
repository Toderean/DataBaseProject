...
CREATE TABLE `servicii` (
  ...
  KEY `cnp` (`cnp`),
  CONSTRAINT `servicii_ibfk_1` FOREIGN KEY (`cnp`) REFERENCES `medic` (`CNP`)
...
INSERT INTO `servicii` VALUES (1,'RMN Torace','Ecografie',100,2,101),(2,'Chirurgie Plastica','Chirurgie',1000,4,102),(3,'Consult general','Consult',50,1,102),(4,'RMN','Ecografie',100,2,101),(5,'Chirurgie','Chirurgie',1000,4,102),(6,'Consult general','Consult',50,1,103);
