...
CREATE TABLE `medic` (
  `CNP` int NOT NULL,
  `codParafa` varchar(30) DEFAULT NULL,
  `titlu` varchar(100) DEFAULT NULL,
  `post` varchar(100) DEFAULT NULL,
  `procent` int NOT NULL,
  KEY `CNP` (`CNP`),
  CONSTRAINT `medic_ibfk_1` FOREIGN KEY (`CNP`) REFERENCES `user1` (`cnp`)
...
INSERT INTO `medic` VALUES (101,'1','doctorand','conferentiar',10),(102,'2','masterand','conferentiar',15),(103,'3','doctorand','conferentiar',20);
