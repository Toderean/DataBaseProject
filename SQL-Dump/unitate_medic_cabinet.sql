...
CREATE TABLE `cabinet` (
  ...
  KEY `unit` (`unit`),
  CONSTRAINT `cabinet_ibfk_1` FOREIGN KEY (`unit`) REFERENCES `unit` (`nume`)
...
INSERT INTO `cabinet` VALUES (1,'cardiologie','Catena'),(2,'pediatrie','Somesana'),(3,'chirurgie','Policlinica 1');
