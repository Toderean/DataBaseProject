...
CREATE TABLE `asistent` (
  `CNP` int NOT NULL,
  `tipul` varchar(30) DEFAULT NULL,
  `grad` varchar(30) DEFAULT NULL,
  KEY `CNP` (`CNP`),
  CONSTRAINT `asistent_ibfk_1` FOREIGN KEY (`CNP`) REFERENCES `user1` (`cnp`)
...
INSERT INTO `asistent` VALUES (104,'asistent general','1'),(105,'generalist','2'),(106,'pediatrie','2');
